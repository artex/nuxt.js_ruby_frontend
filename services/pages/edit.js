...
export default {
    ...
    methods: {
        ...
        edit() {
            if (this.hide === false) {
                this.$store.dispatch('applicant/confirmEdit', this.applicant)
                this.$store.dispatch('applicant/editImg', this.image)
            } else {
                this.applicant.profile_photo = this.editImg
                this.$store.dispatch('applicant/confirmEdit', this.applicant)
            }
        },
